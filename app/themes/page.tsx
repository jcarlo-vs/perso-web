...
function PanelLabel({ n, name, blurb, colors, dark = true }: { n: string; name: string; blurb: string; colors: string[]; dark?: boolean }) {
  return (
    <div className="max-w-sm">
      <p className={`font-mono text-xs tracking-[0.3em] mb-3 ${dark ? "text-white/40" : "text-black/40"}`}>THEME {n} / 05</p>
    ...
    <main className="bg-black">
      ...
      <footer className="py-16 text-center bg-black border-t border-white/10">
        <p className="font-mono text-sm text-neutral-400">
          Pick a number <span className="text-purple-400">01–05</span> and the whole site gets restyled in that direction.
        </p>
